...
dva(a,a.g.Nd(!0))},k9=function(a){g.gH.call(this,"ScreenServiceProxy");
this.Vc=a;this.o=[];this.o.push(this.Vc.$_s("screenChange",(0,g.B)(this.EQ,this)));this.o.push(this.Vc.$_s("onlineScreenChange",(0,g.B)(this.VM,this)))},l9=function(a){g.UG("cloudview",a)},gva=function(a){l9("setApiReady_ "+a);
...
if(!a)return null;var b=r9().Sd();return g.fH(b,a)},pva=function(a,b){u9(!0);
...
a.B.setPlayerContextData(g.eI(b));vva(a)},I9=function(a,b){a.A&&(a.A.removeUpdateListener(a.H),a.A.removeMediaListener(a.F),a.Ak(null));
a.A=b;a.A&&(P9("Setting cast session: "+a.A.sessionId),a.A.addUpdateListener(a.H),a.A.addMediaListener(a.F),a.A.media.length&&a.Ak(a.A.media[0]))},yva=function(a){var b=a.o.media,c=a.o.customData;
...
a.code!=window.chrome.cast.ErrorCode.TIMEOUT&&(this.jc("Retrying "+b+" using MDx browser channel."),L9(this,b,c))},a)},zva=function(a){var b=!1;
...
this.J=a;this.Y=b;this.o=new g.yL(this);g.N(this,this.o);this.o.U(b,"onCaptionsTrackListChanged",this.oM);this.o.U(b,"captionschanged",this.ZK);this.o.U(b,"captionssettingschanged",this.TA);this.o.U(b,"videoplayerreset",this.Cn);this.o.U(b,"mdxautoplaycancel",this.xF);this.M=this.o.U(b,"onVolumeChange",this.rz);this.D=!1;this.g=c;c.subscribe("proxyStateChange",this.Ez,this);c.subscribe("remotePlayerChange",this.Ck,this);c.subscribe("remoteQueueChange",this.Cn,this);c.subscribe("autoplayUpNext",this.ez,
this);c.subscribe("previousNextChange",this.Bz,this);c.subscribe("nowAutoplaying",this.uz,this);c.subscribe("autoplayDismissed",this.dz,this);this.suggestion=null;this.F=new g.JQ(64);this.A=new g.mt(this.OA,500,this);g.N(this,this.A);this.B=new g.mt(this.PA,1E3,this);g.N(this,this.B);this.C={};this.H=new g.mt(this.dB,1E3,this);g.N(this,this.H);this.G=new g.bk(this.zS,1E3,this);g.N(this,this.G);this.L=g.y;this.TA();this.Cn();this.Ck()},W9=function(a,b){var c=a.J,d=a.Y.ha().lengthSeconds;
c.H=b||0;c.g.V("progresssync",b,d)},Nva=function(a){W9(a,0);
a.A.stop();X9(a,new g.JQ(64))},$9=function(a,b){if(Y9(a)&&!a.D){var c=null;
b&&(c={style:a.Y.bl()},g.Zb(c,b));a.g.IA(Z9(a),c);a.C=K9(a.g).o}},a$=function(a,b){var c=a.Y.Tf();
c?wva(a.g,Z9(a),b,c.Qd(),c.listId.toString()):wva(a.g,Z9(a),b);X9(a,new g.JQ(1))},Ova=function(a,b){if(b){var c=a.Y.Yc("captions","tracklist",{wx:1});
...
else{a.B=b;var c=a.g.getPlaylistId();var d=a.g.ha().videoId;if(c||d){var e=a.g.Tf();if(e){var f=[];for(var k=0;k<e.getLength();k++)f[k]=e.dc(k).videoId}else f=[a.g.ha().videoId];c={videoIds:f,listId:c,videoId:d,index:Math.max(a.g.zB(),0),currentTime:a.g.getCurrentTime()}}else c=null;F9("Connecting to: "+g.Lc(b));"cast-selector-receiver"==b.key?(o9(c||null),c=c||null,t9()?m9().setLaunchParams(c):v9("setLaunchParams called before ready.")):!c&&G9()&&p9()==b.key?g.bG("yt-remote-connection-change",!0):
(H9(),o9(c||null),c=r9().Sd(),(c=g.fH(c,b.key))&&D9(c,1))}};
g.p(j9,g.Q0);j9.prototype.H=function(){var a=this.Y.Yc("remote","receivers");a&&1<a.length&&!this.Y.Yc("remote","quickCast")?(this.F=g.Ab(a,this.B,this),g.S0(this,(0,g.I)(a,this.B)),a=this.Y.Yc("remote","currentReceiver"),g.R0(this,this.B(a)),this.enable(!0)):this.enable(!1)};
...
j9.prototype.gd=function(a){g.Q0.prototype.gd.call(this,a);this.Y.He("remote","currentReceiver",this.F[a]);this.A.Xb()};
g.C(k9,g.gH);g.h=k9.prototype;g.h.Sd=function(a){return this.Vc.$_gs(a)};
...
g.h.nB=function(a){if(1==this.g){if(this.o){var b=K9(this),c=new window.chrome.cast.media.SeekRequest;c.currentTime=a;c.resumeState=b.ub()||3==b.g?window.chrome.cast.media.ResumeState.PLAYBACK_START:window.chrome.cast.media.ResumeState.PLAYBACK_PAUSE;this.o.seek(c,g.y,Q9(this,"seekTo",{newTime:a}))}else L9(this,"seekTo",{newTime:a});O9(this,3,a);this.V("remotePlayerChange")}else N9(this,g.ya(this.nB,a))};
...
g.h.vt=function(a,b){if(1==this.g){L9(this,"setAudioTrack",{videoId:a,audioTrackId:b.Mc.id});var c=K9(this);c.audioTrackId=b.Mc.id;M9(this,c)}else N9(this,g.ya(this.vt,a,b))};
g.h.mB=function(a,b){if(1==this.g){if(a&&b){var c=K9(this);g.dI(c,a,b);M9(this,c)}L9(this,"previous")}else N9(this,g.ya(this.mB,a,b))};
g.h.lB=function(a,b){if(1==this.g){if(a&&b){var c=K9(this);g.dI(c,a,b);M9(this,c)}L9(this,"next")}else N9(this,g.ya(this.lB,a,b))};
...
g.h.wt=function(a){if((a!=this.g||2==a)&&3!=this.g&&0!=a){var b=this.g;this.g=a;this.V("proxyStateChange",b,a);if(1==a)for(;!this.C.isEmpty();)g.AB(this.C).apply(this);else 3==a&&this.dispose()}};
...
g.h.Ak=function(a){P9("Cast media: "+!!a);this.o&&this.o.removeUpdateListener(this.G);if(this.o=a)this.o.addUpdateListener(this.G),yva(this),this.V("remotePlayerChange")};
g.h.aL=function(a){a?(yva(this),this.V("remotePlayerChange")):this.Ak(null)};
...
g.h.ut=function(a,b,c,d){c={format:"JSON",method:"POST",context:this,timeout:5E3,withCredentials:!1,Lb:g.ya(this.zQ,c,!0),onError:g.ya(this.yQ,d),Wc:g.ya(this.AQ,d)};b&&(c.Qb=b,c.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.EE(a,c)};
...
g.C(V9,g.M);g.h=V9.prototype;g.h.P=function(){V9.R.P.call(this);this.A.stop();this.B.stop();this.L();this.g.unsubscribe("proxyStateChange",this.Ez,this);this.g.unsubscribe("remotePlayerChange",this.Ck,this);this.g.unsubscribe("remoteQueueChange",this.Cn,this);this.g.unsubscribe("autoplayUpNext",this.ez,this);this.g.unsubscribe("previousNextChange",this.Bz,this);this.g.unsubscribe("nowAutoplaying",this.uz,this);this.g.unsubscribe("autoplayDismissed",this.dz,this);this.g=this.J=null};
g.h.YB=function(a,b){2==this.g.g||(Y9(this)?this.JG.apply(this,arguments):this.FG.apply(this,arguments))};
g.h.ZK=function(a){this.YB("control_subtitles_set_track",g.Sb(a)?null:a)};
g.h.TA=function(){var a=this.Y.Yc("captions","track");g.Sb(a)||$9(this,a)};
...
g.h.rz=function(a){if(Y9(this)){this.g.unsubscribe("remotePlayerChange",this.Ck,this);var b=Math.round(a.volume);a=!!a.muted;var c=K9(this.g);if(b!=c.volume||a!=c.muted)this.g.setVolume(b,a),this.H.start();this.g.subscribe("remotePlayerChange",this.Ck,this)}};
g.h.oM=function(){g.Sb(this.C)||Ova(this,this.C);this.D=!1};
g.h.Ez=function(a,b){this.B.stop();2==b&&this.PA()};
g.h.Ck=function(){if(Y9(this)){this.A.stop();var a=K9(this.g);switch(a.g){case 1081:X9(this,new g.JQ(8));break;case 1:this.OA();X9(this,new g.JQ(8));break;case 1083:case 3:X9(this,new g.JQ(9));break;case 0:X9(this,new g.JQ(2));this.G.stop();W9(this,this.Y.ha().lengthSeconds);break;case 1082:X9(this,new g.JQ(4));break;case 2:X9(this,new g.JQ(4));W9(this,g.cI(a));break;case -1:X9(this,new g.JQ(64));break;case -1E3:a={errorCode:"mdx.remoteerror",message:g.T("YTP_MDX_PLAYER_ERROR")},X9(this,new g.JQ(128,
a))}var a=K9(this.g).o,b=this.C;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.format==b.format&&a.kind==b.kind:1)||(this.C=a,Ova(this,a));a=K9(this.g);-1==a.volume||Math.round(this.Y.getVolume())==a.volume&&this.Y.Fe()==a.muted||this.H.isActive()||this.dB()}else Nva(this)};
g.h.Bz=function(){this.Y.V("mdxpreviousnextchange")};
g.h.Cn=function(){Y9(this)||Nva(this)};
g.h.xF=function(){this.g.Rv()};
g.h.ez=function(a){a&&(a=g.EE("/watch_queue_ajax",{method:"GET",Qc:{action_get_watch_queue_item:1,video_id:a},Lb:(0,g.B)(this.qO,this)}))&&(this.L=(0,g.B)(a.abort,a))};
...
g.h.zS=function(a,b){-1==K9(this.g).g?a$(this,a):b&&this.g.nB(a)};
...
g.h.OA=function(){this.A.stop();if(!this.g.ma()){var a=K9(this.g);a.ub()&&X9(this,new g.JQ(8));W9(this,g.cI(a));this.A.start()}};
g.h.PA=function(){this.B.stop();this.A.stop();var a=this.g.B.getReconnectTimeout();2==this.g.g&&!(0,window.isNaN)(a)&&this.B.start()};g.p(b$,g.W);b$.prototype.B=function(a){Qva(this,a.state)};g.C(c$,g.zV);g.h=c$.prototype;g.h.create=function(){Mva("embedded"==g.X(this.g).g);this.D.push(g.YF("yt-remote-before-disconnect",this.WK,this));this.D.push(g.YF("yt-remote-connection-change",this.zN,this));this.D.push(g.YF("yt-remote-receiver-availability-change",this.Cz,this));this.D.push(g.YF("yt-remote-auto-connect",this.xN,this));this.D.push(g.YF("yt-remote-receiver-resumed",this.wN,this));this.Cz()};
g.h.load=function(){this.g.Fp();c$.R.load.call(this);this.C=new V9(this,this.g,this.o);var a=(a=ova())?a.currentTime:0;var b=G9()?new J9(n9(),void 0):null;0==a&&b&&(a=g.cI(K9(b)));0!=a&&(this.H=a||0,this.g.V("progresssync",a,void 0));Pva(this,this.F,this.F);g.g2(this.g.app,6)};
...
g.h.il=function(a,b){this.loaded&&this.C.YB.apply(this.C,arguments)};
...
g.h.Id=function(){return!1};window._exportCheck==g.Aa&&g.u("ytmod.player.remote",c$,void 0);})(_yt_player);
